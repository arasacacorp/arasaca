          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <span className="text-[12px] font-medium" style={{ color: C.mint }}>О компании</span>
              </motion.nav>
            ...
            >
              {[
                { number: "2018", label: "год основания", icon: Building2, accent: C.dna },
                { number: "50+", label: "проектов", icon: Briefcase, accent: C.mintDark },
                { number: "30+", label: "экспертов", icon: Users, accent: C.orange },
                { number: "2", label: "офиса", icon: MapPin, accent: C.dna },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
