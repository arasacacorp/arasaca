...
export default function EngineeringSubDirectionPage() {
  ...
  const direction = getEngineeringSubDirectionBySlug(slug);
  ...
  const otherDirections = engineeringSubDirections.filter((d) => d.slug !== slug);
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <Link href="/services/engineering" className="text-[12px] transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.4)" }}>
                  Инжиниринг
                </Link>
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
          ...
          >
            ...
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                >
                  Другие направления инжиниринга
                </h2>
              </div>
            ...
            >
              {otherDirections.map((relDirection) => {
                const RelIcon = iconMap[relDirection.icon] || FileSearch;
                return (
                  <motion.div
                    key={relDirection.id}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <Link
                      href={`/services/engineering/${relDirection.slug}`}
