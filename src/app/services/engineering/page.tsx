...
/* ═══════════════════════════════════════════════════════
   COLOUR PALETTE (same as consulting page)
   ═══════════════════════════════════════════════════════ */
const C = {
  dna: "#008C95",
  dnaHover: "#007a82",
...
export default function EngineeringPage() {
  return (
    <main className="min-h-screen flex flex-col" style={{ background: C.muted }}>
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            <motion.div className="flex-1" variants={fadeUp} initial="hidden" animate="visible" custom={0.1}>
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <span className="text-[12px] font-medium" style={{ color: C.mint }}>Инжиниринг</span>
              </motion.nav>
              ...
              >
                Оценка, проектирование, контроль и управление стройкой — для надёжной реализации сложных объектов. Технологическая, правовая и организационная поддержка инвестиционно-строительных проектов.
              </motion.p>
      ...
      {/* ═══════════════════════════════════════════════════
          DIRECTIONS — Engineering sub-directions with unique card design
          ═══════════════════════════════════════════════════ */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            {engineeringSubDirections.map((direction, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={`/services/engineering/${direction.slug}`}
        ...
        <div className="container-kept">
          ...
          >
            ...
            <p className="text-[14px] font-normal leading-relaxed max-w-sm lg:text-right" style={{ color: "rgba(255,255,255,0.5)" }}>
              От обоснования инвестиций до сдачи объекта — сопровождаем строительные проекты на всех этапах. Обеспечиваем контроль качества, сроков и бюджета.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: FileSearch,
                title: "Обоснование",
                description: "Предпроектный анализ и оценка реализуемости",
                step: "01",
              },
              {
                icon: Microscope,
                title: "Экспертиза",
                description: "Аудит документации и стоимости проекта",
                step: "02",
              },
              {
                icon: HardHat,
                title: "Реализация",
                description: "Управление строительством и контроль качества",
                step: "03",
              },
            ].map((item, index) => (
              <motion.div
