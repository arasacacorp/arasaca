...
export default function HRPage() {
  return (
    <main className="min-h-screen flex flex-col" style={{ background: C.muted }}>
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            <motion.div className="flex-1" variants={fadeUp} initial="hidden" animate="visible" custom={0.1}>
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <span className="text-[12px] font-medium" style={{ color: C.mint }}>HR и организационное развитие</span>
              </motion.nav>
              ...
              >
                Управление человеческим капиталом, организационное проектирование и HR-аналитика для построения эффективных команд и устойчивого развития организации.
              </motion.p>
      ...
      {/* ═══════════════════════════════════════════════════
          DIRECTIONS — HR sub-directions with unique card design
          ═══════════════════════════════════════════════════ */}
          ...
          >
            <div>
              ...
              <h2 className="heading-section" style={{ color: C.textDark }}>
                Направления HR и организационного развития
              </h2>
            </div>
            <p className="text-[14px] font-normal leading-relaxed max-w-xs lg:text-right" style={{ color: C.textMuted }}>
              Три ключевых направления для<br />развития человеческого капитала
            </p>
          </motion.div>

          {/* Cards Grid — 3 columns for 3 items */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            {hrSubDirections.map((direction, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={`/services/hr/${direction.slug}`}
        ...
        <div className="container-kept">
          ...
          >
            ...
            <p className="text-[14px] font-normal leading-relaxed max-w-sm lg:text-right" style={{ color: "rgba(255,255,255,0.5)" }}>
              От диагностики до внедрения: создаём системы управления талантами, развиваем организационную эффективность и строим HR-аналитику.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Users,
                title: "Диагностика",
                description: "Оценка текущего состояния HR-функции и культуры",
                step: "01",
              },
              {
                icon: Network,
                title: "Проектирование",
                description: "Разработка целевой модели и программ развития",
                step: "02",
              },
              {
                icon: BarChart2,
                title: "Внедрение",
                description: "Реализация изменений и измерение результатов",
                step: "03",
              },
            ].map((item, index) => (
              <motion.div
