...
export default function HRSubDirectionPage() {
  ...
  const direction = getHRSubDirectionBySlug(slug);
    ...
    return (
      <main className="min-h-screen flex items-center justify-center" style={{ background: C.muted }}>
        <div className="text-center">
          ...
          <Link href="/services/hr" className="text-[#008C95] hover:underline">
            Вернуться к HR и организационному развитию
          </Link>
        </div>
      </main>
    );
  ...
  const IconComponent = iconMap[direction.icon] || Users;

  // Get all other directions for carousel
  const otherDirections = hrSubDirections.filter((d) => d.slug !== slug);
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <Link href="/services/hr" className="text-[12px] transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.4)" }}>
          ...
          >
            ...
            >
              {otherDirections.map((relDirection) => {
                const RelIcon = iconMap[relDirection.icon] || Users;
                return (
                  <motion.div
                    key={relDirection.id}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <Link
                      href={`/services/hr/${relDirection.slug}`}
            ...
            <div className="mt-10">
              <Link
                ...
                style={{ color: C.mint }}
              >
                Все направления HR и организационного развития
