...
export default function LearningSubDirectionPage() {
  ...
  const direction = getLearningSubDirectionBySlug(slug);
    ...
    return (
      <main className="min-h-screen flex items-center justify-center" style={{ background: C.muted }}>
        <div className="text-center">
          ...
          <Link href="/services/learning" className="text-[#008C95] hover:underline">Вернуться к обучению и развитию</Link>
        </div>
      </main>
    );
  }
  ...
  const otherDirections = learningSubDirections.filter((d) => d.slug !== slug);
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <Link href="/services/learning" className="text-[12px] transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.4)" }}>
                  Обучение и развитие
                </Link>
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                <h2 className="mt-3" style={{ fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 700, lineHeight: 1.25, color: C.white }}>Другие направления обучения</h2>
              </div>
            ...
            <div ref={scrollContainerRef} className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide" style={{ scrollbarWidth: "none", msOverflowStyle: "none", WebkitOverflowScrolling: "touch" }}>
              {otherDirections.map((relDirection) => {
                const RelIcon = iconMap[relDirection.icon] || GraduationCap;
                return (
            ...
            <div className="mt-10">
              <Link href="/services/learning" className="inline-flex items-center gap-2 font-medium transition-all duration-300 hover:gap-3" style={{ color: C.mint }}>
                Все направления обучения и развития
