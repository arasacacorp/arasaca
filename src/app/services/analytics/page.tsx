...
export default function AnalyticsPage() {
  return (
    <main className="min-h-screen flex flex-col" style={{ background: C.muted }}>
        ...
        <div className="container-kept relative z-10">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            <motion.div className="flex-1" variants={fadeUp} initial="hidden" animate="visible" custom={0.1}>
              ...
              >
                Глубокий анализ рынков, данных и трендов для принятия обоснованных стратегических решений. Превращаем информацию в конкурентное преимущество.
              </motion.p>
      ...
      {/* ═══════════════════════════════════════════════════
          DIRECTIONS — Analytics sub-directions with unique card design
          ═══════════════════════════════════════════════════ */}
        ...
        <div className="container-kept">
          ...
          >
            ...
            <p className="text-[14px] font-normal leading-relaxed max-w-xs lg:text-right" style={{ color: C.textMuted }}>
              Три ключевых направления для<br />глубокого понимания рынка и&nbsp;данных
            </p>
          </motion.div>

          {/* Cards Grid — 3 cards, full width */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            {analyticsSubDirections.map((direction, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={`/services/analytics/${direction.slug}`}
        ...
        <div className="container-kept">
          ...
          >
            ...
            <p className="text-[14px] font-normal leading-relaxed max-w-sm lg:text-right" style={{ color: "rgba(255,255,255,0.5)" }}>
              От сбора данных до actionable insights — превращаем информацию в&nbsp;понятные выводы и&nbsp;практические рекомендации для развития бизнеса.
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Search,
                title: "Сбор данных",
                description: "Первичные и вторичные исследования, анализ данных",
                step: "01",
              },
              {
                icon: BarChart3,
                title: "Анализ",
                description: "Статистическая обработка, моделирование и визуализация",
                step: "02",
              },
              {
                icon: TrendingUp,
                title: "Рекомендации",
                description: "Практические выводы и стратегические решения",
                step: "03",
              },
            ].map((item, index) => (
              <motion.div
