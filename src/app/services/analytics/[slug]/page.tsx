...
export default function AnalyticsSubDirectionPage() {
  ...
  const direction = getAnalyticsSubDirectionBySlug(slug);
  ...
  const otherDirections = analyticsSubDirections.filter((d) => d.slug !== slug);
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <Link href="/services/analytics" className="text-[12px] transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.4)" }}>
          ...
          >
            ...
            >
              {otherDirections.map((relDirection) => {
                const RelIcon = iconMap[relDirection.icon] || Search;
                return (
                  <motion.div
                    key={relDirection.id}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <Link
                      href={`/services/analytics/${relDirection.slug}`}
