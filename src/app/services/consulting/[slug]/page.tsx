    ...
    >
      ...
      >
        <div className="flex items-center gap-3 pr-4">
          {/* Left accent dot for top services */}
          {service.isTop && (
...
export default function ConsultingSubDirectionPage() {
  ...
  const direction = getConsultingSubDirectionBySlug(slug);
    ...
    return (
      <main className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/services/consulting" className="text-[#008C95] hover:underline">
            Вернуться к консалтингу
          </Link>
        </div>
      </main>
    );
  ...
  // Get all other directions for carousel
  const otherDirections = consultingSubDirections.filter((d) => d.slug !== slug);
  ...
  return (
    <main className="min-h-screen flex flex-col" style={{ background: C.muted }}>
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <Link href="/services/consulting" className="text-[12px] transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.4)" }}>
                  Консалтинг
                </Link>
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
      ...
      {/* ═══════════════════════════════════════════════════
          SERVICES — Accordion list with styled header
          ═══════════════════════════════════════════════════ */}
        ...
        <div className="container-kept relative z-10">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-10">
              <div>
                <span
                  className="mb-3 inline-flex items-center gap-1.5 px-2.5 py-1 text-[9px] font-bold uppercase tracking-wider"
                  style={{
                    background: "rgba(0,140,149,0.15)",
                    color: C.mint,
                    borderRadius: "2px",
                ...
                >
                  Другие направления консалтинга
                </h2>
              </div>
            ...
            >
              {otherDirections.map((relDirection) => {
                const RelIcon = iconMap[relDirection.icon] || Target;
                return (
                  <motion.div
                    key={relDirection.id}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <Link
                      href={`/services/consulting/${relDirection.slug}`}
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.borderColor = "rgba(0,140,149,0.4)";
                      }}
                      onMouseLeave={(e) => {
                    ...
                    >
                      {/* Icon */}
                      <div
                        className="w-11 h-11 flex items-center justify-center rounded-lg mb-4 transition-colors duration-300"
                      ...
                      {/* Title */}
                      <h3
                        className="mb-2 text-[15px] font-semibold transition-colors duration-300"
                        style={{ color: C.white }}
                      >
                        {relDirection.shortTitle}
                      </h3>
                      {/* Description */}
                      <p
                      ...
                      >
                        {relDirection.description}
                      </p>
                      {/* Arrow indicator */}
                      <div
                        className="mt-4 flex items-center gap-1.5 text-[12px] font-medium transition-all duration-300"
                        style={{ color: C.dna }}
                      >
                        Подробнее
