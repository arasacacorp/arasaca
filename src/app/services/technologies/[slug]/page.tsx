...
export default function TechnologiesSubDirectionPage() {
  ...
  const direction = getTechnologiesSubDirectionBySlug(slug);
    ...
    return (
      <main className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/services/technologies" className="text-[#008C95] hover:underline">
  ...
  const otherDirections = technologiesSubDirections.filter((d) => d.slug !== slug);
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
                <Link href="/services/technologies" className="text-[12px] transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.4)" }}>
                  Технологии
                </Link>
                <ChevronRight className="w-3 h-3" style={{ color: "rgba(255,255,255,0.25)" }} />
          ...
          >
            ...
            >
              {otherDirections.map((relDirection) => {
                const RelIcon = iconMap[relDirection.icon] || RefreshCw;
                return (
                  <motion.div
                    key={relDirection.id}
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <Link
                      href={`/services/technologies/${relDirection.slug}`}
