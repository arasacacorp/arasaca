          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <span className="text-[12px] font-medium" style={{ color: C.mint }}>Пресс-центр</span>
              </motion.nav>
              ...
              >
                <Link href="/press-center" className="sm:auto">
                  <motion.span
                    ...
                    whileHover={{ background: C.dna, transition: { duration: 0.3 } }}
                  >
                    Все публикации
                    <ArrowRight className="h-4 w-4" />
                  </motion.span>
                </Link>
                <Link href="#subscription" className="sm:auto">
                  <motion.span
            ...
            >
              {[
                { number: "50+", label: "публикаций", icon: Newspaper, accent: C.dna },
                { number: "12+", label: "новостей", icon: Megaphone, accent: C.mintDark },
                { number: "20+", label: "статей", icon: BookOpen, accent: C.orange },
                { number: "15+", label: "инсайтов", icon: TrendingUp, accent: C.dna },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
