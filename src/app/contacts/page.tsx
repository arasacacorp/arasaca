          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between py-6 md:py-10 lg:py-12">
            ...
            >
              ...
              >
                ...
                <span className="text-[12px] font-medium" style={{ color: C.mint }}>Контакты</span>
              </motion.nav>
              ...
              >
                <Link href="/feedback" className="sm:auto">
                  <motion.span
            ...
            >
              {[
                { number: "2", label: "офиса", icon: Building2, accent: C.dna },
                { number: "24/7", label: "поддержка", icon: Clock, accent: C.mintDark },
                { number: "+7", label: "код страны", icon: Phone, accent: C.orange },
                { number: "15+", label: "каналов связи", icon: Mail, accent: C.dna },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
